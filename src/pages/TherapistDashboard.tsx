                ...
                <div className="bg-card rounded-xl border border-border p-6">
                  <div className="flex items-center gap-4 mb-6">
                     ...
                     <div>
                       ...
                       <p className="text-muted-foreground">
                         {profile.schedulingMode === 'slots' ? 'ניהול לפי תורים ספציפיים' : 'ניהול לפי ימי קבלה'}
                       </p>
                     </div>
                  </div>
                ...
                <div className="bg-card rounded-xl border border-border p-6 space-y-8">
                  ...
                  <div className="space-y-3 pt-4 border-t border-border">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div
                        onClick={() => {
                            setProfile({ ...profile, schedulingMode: 'slots' });
                      ...
                      >
                        ...
                        <div className="text-xs text-muted-foreground">אפשר למטופלים לראות תורים פנויים ולהזמין ישירות</div>
                      </div>

                      <div
                        onClick={() => {
                            setProfile({ ...profile, schedulingMode: 'reception_days' });
                            setIsAvailabilityOpen(true);
                        }}
                        className={`p-4 rounded-xl border cursor-pointer transition-all relative ${
                          profile.schedulingMode === 'reception_days'
                            ? 'border-primary bg-primary/5 ring-1 ring-primary'
                            : 'border-border hover:border-primary/50'
                        }`}
                      >
                        ...
                        <div className="text-xs text-muted-foreground">הצג רק את ימי ושעות הפעילות ללא אפשרות הזמנה ישירה</div>
                      </div>
                    </div>
                  </div>
